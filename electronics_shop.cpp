 ...
 */
int getMoneySpent(vector<int> keyboards,int n, vector<int> drives,int m, int b) 
{
    int i,j,max=0,count=0,flag=1;
...
int main()
{
    ...
    int moneySpent = getMoneySpent(keyboards,n, drives,m, b);
